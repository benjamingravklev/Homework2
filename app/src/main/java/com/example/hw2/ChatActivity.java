...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        welcome.setText("Hello " + account.getDisplayName());
    ...
    private void sendCloudMessage(chatMessage m) {
        String serverKey = "AAAAflT_TqA:APA91bFg3TEB0ta0ahRzPxodyfpgIoIQ7zV2ohS7DFvdolK3-idJhBDdHMlAmZTeh7uSk_o5LvMLiJF4rBfE2rV8fnbeq1nunMlhuPdRS7qKPiOYeO_kgcaVdhDWRGKl_0vCh5NTUsyx";
        String topic = "chat";
